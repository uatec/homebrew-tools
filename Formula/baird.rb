...
class Baird < Formula
  ...
  url "https://github.com/uatec/baird/releases/download/v0.0.135/Baird-linux-arm64.zip",
      using: PrivateGitHubDownloadStrategy
  version "0.0.135"
  sha256 "fad85d440a627a5404084418f104176698a5c9de199bd0b72a84972eed9007ad"
