...
class Sysupdate < Formula
  ...
  url "https://github.com/uatec/sysupdate/releases/download/v0.0.7/sysupdate-osx-arm64.zip",
      using: PrivateGitHubDownloadStrategy
  version "0.0.7"
  sha256 "c60747a3b36ade9485b73ee9d6e9029187be7ff04721a0d628ee133934caadb9"
